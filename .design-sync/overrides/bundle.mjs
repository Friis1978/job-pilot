// forked from design-sync lib/bundle.mjs — polyfill process.* for Next.js apps
// (process.platform, process.nextTick, process.stdout used by recharts/insforge/react deps)
...
function sharedBuildOptions({ nodePaths, tsconfig }) {
  ...
  return {
    ...
    define: {
      ...
      'process.env.NEXT_PUBLIC_INSFORGE_URL': '"https://8kj4iaqv.eu-central.insforge.app"',
      'process.env.NEXT_PUBLIC_INSFORGE_ANON_KEY': '"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3OC0xMjM0LTU2NzgtOTBhYi1jZGVmMTIzNDU2NzgiLCJlbWFpbCI6ImFub25AaW5zZm9yZ2UuY29tIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA5OTI5NTR9.SDNMMrjUFc68d4iCzPQixW4sN3MX2cS9qoWgXF3JbE4"',
    },
  };
}
...
export async function bundleToIife({ entry, globalName, nodePaths, out, tsconfig }) {
  ...
  try {
    buildResult = await build({
      ...
      banner: { js: 'if(typeof process==="undefined"){var process={env:{NODE_ENV:"development"},platform:"browser",version:"v18.0.0",nextTick:function(f,a){return setTimeout(function(){f(a);},0);},argv:[],stdout:{write:function(){}},stderr:{write:function(){}},hrtime:function(){return[0,0];},cwd:function(){return"/";},exit:function(){}};} ' },
      ...
      alias: {
        'next/navigation': new URL('../next-navigation-mock.mjs', import.meta.url).pathname,
        'next/link': new URL('../next-link-mock.mjs', import.meta.url).pathname,
        'next/image': new URL('../next-image-mock.mjs', import.meta.url).pathname,
      },
      outfile: bundleJs,
      logLevel: 'warning',
